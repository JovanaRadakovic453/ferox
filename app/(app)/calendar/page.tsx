...
export default async function CalendarPage({
  ...
  const [
    ...
    supabase
      ...
      .select('id, for_date, name, priority, note, remind_before_minutes')
      .eq('user_id', user.id)
  ...
  return (
    <CalendarView
      ...
      scheduled={(scheduled ?? []) as { id: string; for_date: string; name: string; priority: string; note: string; remind_before_minutes: number | null }[]}
    />
  )
}
